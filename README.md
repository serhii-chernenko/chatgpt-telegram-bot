...
3. Далі потрібен VPN. Можна обрати [ClearVPN](https://clearvpn.com/ua/), який є безкоштовним для українців.
4. Бажано обрати країну підключенняу VPN ту саму, з якої у вас буде номер телефону для реєстрації.
5. Зареєструвався з підтвердженням коду на номер телефону друга.
6. Після реєстрації вже ні номер, ні VPN не будуть потрібні, навіть якщо користуватися напряму в самому сервісі:<br/>https://chat.openai.com/
7. Після цього можеш рухатися далі по інструкції.
